...
<div class='well well-small'>
  ...
  <h4>posted by <a href='/users/<?= $update->user->username ?>'><?= $update->user->username ?></a> in <a href='/projects/<?= $gp->slug ?>'><?= strtolower($gp->title) ?></a> &raquo; <a href='/goals/<?= $goal->uuid ?>'><?= strtolower($goal->name) ?></a> on <?= date("m-d-Y", $update->dateAdded) ?></h4>
